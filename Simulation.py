...
q_tot = 3*q_heater_r + 4*q_heater_b # en W
Etot = q_tot * (temps_q_on) # en kWh
# Graphique de T2 en fonction du temps
print('Les heaters ont été activés pendant', temps_q_on, 'heures. l\'énergie totale consommée est de', Etot/1000, 'kWh.')
